...
urlpatterns = [
 ...
 #  ----------------------------- TINTO urls LOAN  END-----------------------------
    ...
    path('accounttype_summary', views.accounttype_summary, name='accounttypesummary'),
    path('accounttypesummary_mail', views.accounttypesummary_mail, name='accounttypesummary_mail'),
    # End
